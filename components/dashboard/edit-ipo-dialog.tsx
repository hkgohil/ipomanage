...
import { useIPOStore, type IPO } from "@/lib/ipo-store"
...
export function EditIPODialog({ open, onOpenChange, ipo }: EditIPODialogProps) {
  ...
  const [formData, setFormData] = useState({
    ...
    retailPortion: ipo.retailPortion,
    greyMarketPremium: ipo.greyMarketPremium.toString(),
    recommendation: ipo.recommendation,
    allotmentLink: ipo.allotmentLink,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>Update IPO details and status</DialogDescription>
        </DialogHeader>
